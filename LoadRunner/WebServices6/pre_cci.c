# 1 "c:\\users\\simon\\desktop\\ipr\\webservices6\\\\combined_WebServices6.c"
...
# 1 "c:\\users\\simon\\desktop\\ipr\\webservices6\\\\combined_WebServices6.c" 2
...
# 2 "c:\\users\\simon\\desktop\\ipr\\webservices6\\\\combined_WebServices6.c" 2
...
# 3 "c:\\users\\simon\\desktop\\ipr\\webservices6\\\\combined_WebServices6.c" 2
...
vuser_init()
{
	...
	int random = 0;
		...
		ppp = vtc_connect("127.0.0.1", 8888, 0x01);
...
# 5 "c:\\users\\simon\\desktop\\ipr\\webservices6\\\\combined_WebServices6.c" 2
	...
	Action()
{
   ...
   ppp = vtc_connect("127.0.0.1", 8888, 0x01);
   vvv = vtc_connect("127.0.0.1", 1010, 0x01);
   ...
   vtc_column_size( ppp,"city", &colsize );
    ...
    lr_save_datetime("%Y-%m-%dT00:00:00", 0, "dateStart");
    lr_save_datetime("%Y-%m-%dT00:00:00", 0 +(1*86400), "dateEnd");
    lr_save_datetime("%Y-%m-%d", 0, "dateToVts");
    
    
		if (strstr("fakeData", lr_eval_string("{city}")) != 0) {
			
			lr_output_message("%s is not found", lr_eval_string("{city}"));
			
			lr_end_transaction("getWeather", 1);
...
# 6 "c:\\users\\simon\\desktop\\ipr\\webservices6\\\\combined_WebServices6.c" 2
...
# 7 "c:\\users\\simon\\desktop\\ipr\\webservices6\\\\combined_WebServices6.c" 2
